...
# r\_t = \\log\\left(\\frac{P\_t}{P\_{t-1}}\\right)
...
# annual\_returns = 252 \* returns.mean()

# cov\_matrix = 252 \* returns.cov()
...
# \- \\(x\_i = 1\\) means stock \*i\* is selected  

# \- \\(x\_i = 0\\) means stock \*i\* is excluded
